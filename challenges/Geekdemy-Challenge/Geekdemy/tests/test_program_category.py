...
class TestProgramCategory(TestCase):
    ...
    def setUp(self):
        self.program_category = ProgramCategory(name="DIPLOMA", cost=1000.0, pro_discount=0.1)
    ...
    def test_get_pro_discount(self):
        self.assertEqual(self.program_category.get_pro_discount(), 100.0)